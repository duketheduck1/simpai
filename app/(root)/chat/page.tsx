...
import { getChatResponse} from "@/server/actions/openai";
...
const Page = () => {
  ...
  const sendInput = async () => {
    ...
    setLoading(true);
    const data = await getChatResponse({input, idClerk, author}) ;
  ...
  return (
    <section className="w-full h-screen p-4">
      <div className="fixed top-0 flex flex-wrap items-center justify-between gap-2 z-10 bg-gray-400 w-full">
        <h2 className="text-2xl font-semibold p-2 ">Chatbot</h2>
      </div>
